      ...
      {isOpen && (
        ...
        >
          <motion.div 
            ...
            className="w-full max-w-xl bg-[#1f2937] border border-[#374151] rounded-xl overflow-hidden shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-center justify-between px-6 py-4 bg-[#111827] border-b border-[#374151]">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full min-h-32 px-4 py-3 bg-[#111827] border border-[#374151] rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#006239] focus:border-transparent transition-all resize-none"
                  autoFocus
                />
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-4 bg-[#111827] border-2 border-dashed border-[#374151] rounded-xl text-gray-400 hover:border-[#006239] hover:bg-[#006239]/5 transition-all"
                >
                  <Upload size={20} />
              ...
              {/* Image Preview */}
              {imageBlobUrl && (
                <div className="relative w-full h-52 rounded-xl overflow-hidden border border-[#374151] group">
                  <img
                    src={imageBlobUrl}
                    alt="Preview"
            ...
            {/* Footer */}
            <div className="px-6 py-4 bg-[#111827] border-t border-[#374151] flex gap-3 justify-end">
              <button
                onClick={onClose}
                className="px-4 py-2 rounded-lg border border-[#374151] hover:bg-white/10 text-gray-300 font-semibold transition-colors"
              >
                Cancel
              </button>
              <motion.button
