...
export default function PostCreator({ onCreatePost }: { onCreatePost: (title: string, content: string) => void }) {
    ...
    <div className="bg-card border border-border rounded-lg p-5 space-y-4">
      ...
      <div className="space-y-3">
        <input
          ...
          className="w-full px-4 py-2 bg-background border border-border/50 rounded-lg text-foreground placeholder-foreground/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-all text-sm"
        />
